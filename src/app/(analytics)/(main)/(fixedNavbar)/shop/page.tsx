...
const ShopHome: React.FC<PageParams> = ({ searchParams }) => {
    ...
    const search = new URLSearchParams(Object.entries(searchParams).reduce((prev, [key, value]) => {
    ...
    return (
        <div className="flex w-full flex-grow flex-col items-center px-4">
            <div className="mx-auto mb-10 mt-3 grid w-full max-w-7xl flex-1 grid-cols-1 lg:gap-4 lg:grid-cols-12">
                ...
                <div className="order-2 col-span-8 lg:order-none lg:col-span-2 mb-2 lg:mb-0">
                    <SearchSettingsList queryKey="sort" items={[
                        {
