...
const GDriveConfigScreen: React.FC<{ ctx: RenderManualFieldExtensionConfigScreenCtx }> = ({ ctx }) => {
    ...
    return (
        <Canvas ctx={ctx}>
            <Form>
                <SwitchField error={errors.limitAssets} onChange={update.bind(null, "limitAssets")} value={formValues.limitAssets ?? false} name="limitAssets" id="limitAssets" label="Limit Assets" />
