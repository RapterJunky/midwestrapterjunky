...
const ShippingPanel: React.FC<Props> = ({ next, checkout: [checkoutState, dispatch], active }) => {
    ...
    return (
        <div id="tab-2" role="tabpanel" tabIndex={1} aria-labelledby="tab-btn-2" data-headlessui-state={active ? "selected" : undefined} className={active ? undefined : "hidden"}>
