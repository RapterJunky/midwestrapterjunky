    ...
    return (
        <div className='grid justify-center rounded-sm pb-2 mb-4 w-full px-4 grid-cols-1 lg:grid-cols-3 shadow'>
            ...
            <div className="order-1 w-full flex justify-end items-center pr-4 mb-4 lg:mb-0 lg:order-none">
                <button aria-label='Shopping Cart' className="transition-transform hover:transform hover:scale-110 relative">
                    <HiShoppingBag className="h-7 w-7" />
                    <span className="ml-2 absolute -left-4 -bottom-2 inline-block whitespace-nowrap rounded-[0.27rem] bg-danger-100 px-[0.65em] pt-[0.35em] pb-[0.25em] text-center align-baseline text-xs font-bold leading-none text-danger-700">1</span>
                </button>
            </div>
        </div>
    );
