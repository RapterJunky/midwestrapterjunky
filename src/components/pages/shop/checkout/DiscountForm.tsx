            ...
            <div className="mb-4">
                ...
                <div className="flex gap-2">
                    <Input data-cy="discount-input"
                        ...
                        id="discount"
                        type="text" />
                    <Button disabled={loading} data-cy="discount-input-enter"
                        onClick={addDiscount}
                        type="button">
                    ...
                    <ul>
                        {state.discounts.map((discount) => (
                            <li className="flex items-center" key={discount.id}>
                                <Button title="Remove discount" aria-label={`Remove discount ${discount.name}`} className="hover:text-red-600" variant="ghost" size="icon" data-cy="discount-remove"
                                    onClick={() => {
