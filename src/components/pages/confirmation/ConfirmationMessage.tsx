...
const ConfirmationMessage: React.FC = () => {
    ...
    const shopReceiptUrl = decodeURIComponent((searchParams?.get("shop_receipt")?.toString() ?? ""));
    const isVaildUrl = shopReceiptUrl.startsWith("https://squareupsandbox.com/receipt") || shopReceiptUrl.startsWith("https://squareup.com/receipt")
