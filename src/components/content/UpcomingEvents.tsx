    ...
    <section className="flex w-full flex-wrap">
      {props.events.map((event, i) => (
        <div key={i} className="relative flex w-2/4 justify-center md:w-1/4">
          ...
          <div className="bg-opacity absolute top-0 flex h-full w-full flex-col items-center justify-center gap-5 bg-gray-900 p-2 transition-opacity duration-150 ease-in-out hover:opacity-100 md:opacity-0">
