...
export type ConfigFetcher = {
    getConfig<T extends string | boolean | number = boolean>(): Promise<ProjectConfig<T> | null>
}
...
export default class ConfigServiceBase {
    ...
    protected async fetch<T extends string | boolean | number = boolean>(lastConfig: ProjectConfig<T> | null, config?: RequestInit): Promise<ProjectConfig<T> | null> {
        try {
    ...
    protected async refresh<T extends string | boolean | number = boolean>(lastConfig: ProjectConfig<T> | null): Promise<ProjectConfig<T> | null> {
