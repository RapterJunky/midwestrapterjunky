 ...
 */
export const formatLocalDate = (date: Date | string | null, locale?: string, options?: Intl.DateTimeFormatOptions) => {
  const data = date ? typeof date === "string" ? new Date(date) : date : new Date();
