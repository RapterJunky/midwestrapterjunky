...
const genericSeoTags = ({
  ...
  url = "https://midwestraptorjunkies.com",
    ...
    },
    {
      ...
      attributes: {
        name: "twitter:image",
        content: `${process.env.VERCEL_ENV === "development" ? "http" : "https"}://${process.env.VERCEL_URL}/twitter-image`
      }
    },
    {
      tag: "meta",
    ...
    },
    {
      ...
      attributes: {
        property: "og:image",
        content: `${process.env.VERCEL_ENV === "development" ? "http" : "https"}://${process.env.VERCEL_URL}/opengraph-image`
      }
    },
    {
      tag: "meta",
