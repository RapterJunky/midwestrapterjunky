            ...
            <main className="flex-1 flex justify-center">
                <article className="prose prose-sm md:prose-base lg:prose-md my-8 mx-4">
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Midwest Raptor Junkies.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to Midwest Raptor Junkies, accessible from <a href="https://midwestraptorjunkies.com" rel="external nofollow noopener" target="_blank">https://midwestraptorjunkies.com</a></p>
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>By email: rapterjunky@gmail.com</li>
                    </ul>
                </article>
            </main>
