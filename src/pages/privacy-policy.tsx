      ...
      <SiteTags
        tags={[
          ...
          [
            {
              tag: "title",
              content: `Privacy Policy - Midwest Raptor Junkies`,
            },
          ],
        ]}
      />
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Midwest Raptor Junkies.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Midwest Raptor Junkies,
                accessible from{" "}
                <a
                  href="https://midwestraptorjunkies.com"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://midwestraptorjunkies.com
                </a>
              </p>
            </li>
            <li>
