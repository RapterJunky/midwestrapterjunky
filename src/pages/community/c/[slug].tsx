import type { NextPage, GetStaticPropsContext, GetStaticPathsResult, GetStaticPropsResult } from "next";
...
export const getStaticProps = async (ctx: GetStaticPropsContext): Promise<GetStaticPropsResult<{}>> => {
            ...
            <main className="mt-28 flex flex-1 flex-col items-center">
                <div className="container mb-4 flex max-w-6xl flex-col justify-center px-2">
                    ...
                    <section className="flex flex-col md:flex-row gap-4 items-center">
                        <div>
                            <Image className="rounded-full" src={category.image} alt="category" height={150} width={150} />
                        </div>
                        <p className="text-xl">{category.description}</p>
                    </section>
                    <TopicsList sort="top" mode="category" categoryId={category.id.toString()} />
                </div>
            </main>
            <Footer />
        </div>
