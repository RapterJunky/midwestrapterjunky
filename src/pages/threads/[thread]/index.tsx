        ...
        <div className="container flex flex-1 flex-col sm:px-6">
          ...
          <div className="mt-4 flex w-full flex-col justify-between gap-2 p-2 sm:flex-row">
            ...
            <Link
              ...
              className="flex items-center justify-center rounded bg-primary px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)]"
            >
              Create Post
            </Link>
          </div>
          <div className="mt-4 flex flex-1 flex-col gap-4">
            ...
            <div className="mb-10 mt-auto flex items-center justify-evenly">
              <button
